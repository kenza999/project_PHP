...
// C'est au clic qu'une action se déclenche sur la DIV cookies :on met en place la methode addEventListener.
btnSuccess.addEventListener('click', function(){
    console.log('Vous avez cliqué sur le bouton !!!');
});
// J'utilise la propriété .style Notre objectif est de rendre la DIV cookies invisible 
btnSuccess.addEventListener('click', function(){
    console.log('Vous avez cliqué sur le bouton!!!');
...
document.getElementById('savePreferences').addEventListener('click', function() {
    ...
    var functionalConsent = document.getElementById('functional-cookies').checked;

    // Sauvegarder ces préférences
    // Exemple: localStorage.setItem('analyticsConsent', analyticsConsent);
    // Vous devrez implémenter la logique pour respecter ces préférences sur votre site
